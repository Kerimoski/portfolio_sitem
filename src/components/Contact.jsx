      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
            İşbirliği için benimle İletişime geçin
          </h2>

          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
          Bana ulaşın, proje ihtiyaçlarınızı tartışalım ve aklınızdaki fikri hayat geçirmek için işbirliğine başlayalım!
          </p>
        ...
        <form
          action="https://getform.io/f/arolzykb"
          method="POST"
          className="xl:pl-10 2xl:pl-20"
          onSubmit={() => {
            // Analytics tracking
            if (typeof window !== 'undefined' && window.trackContactForm) {
              window.trackContactForm('portfolio_contact');
            }
          }}
        >
